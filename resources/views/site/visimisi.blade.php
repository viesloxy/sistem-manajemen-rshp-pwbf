...
<section id="visimisi">
    ...
    <table>
        <tr>
            <th>Visi</th>
            <td>Menjadi rumah sakit hewan pendidikan yang unggul dalam pelayanan, pendidikan, dan penelitian untuk meningkatkan kesejahteraan hewan dan masyarakat.</td>
        </tr>
        <tr>
            <th>Misi</th>
            <td>

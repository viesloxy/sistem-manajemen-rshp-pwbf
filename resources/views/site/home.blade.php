...
<section id="tentang">
    ...
    <div class="struktur-berita">
        <div class="struktur-card">
            ...
            <img src="{{ asset('images/berita1_rshp.png') }}" alt="Berita 1" class="struktur-foto">
        ...
        <div class="struktur-card">
             {{-- DIUBAH: 'image/' menjadi 'images/' --}}
            <img src="{{ asset('images/berita2_rshp.png') }}" alt="Berita 2" class="struktur-foto">
            <div class="struktur-info">
                <h3>Berita 2</h3>
        ...
        <div class="struktur-card">
             {{-- DIUBAH: 'image/' menjadi 'images/' --}}
            <img src="{{ asset('images/berita3_rshp.jpg') }}" alt="Berita 3" class="struktur-foto">
            <div class="struktur-info">
                <h3>Berita 3</h3>
